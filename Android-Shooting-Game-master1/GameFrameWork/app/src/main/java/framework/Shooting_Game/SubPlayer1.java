...
public class SubPlayer1 extends SpriteAnimation {
    ...
    int m_Life =3;
    int skills=3;
    private int PlayerShootSpeed=100; //발사 빈도
    @Override
    ...
    public void Update(long gameTime) {
        ...
        m_BoundBox.set(getX(),getY(),getX()+getBitmapWidth()/6-100,getY()+getBitmapHeight()/8);
    }

    public SubPlayer1(Bitmap bitmap) {
        super(bitmap);
    ...
    public void SetItem(Item item){item.useItem(this); }
}